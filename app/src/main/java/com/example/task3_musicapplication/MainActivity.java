...
import static com.example.task3_musicapplication.R.id.musicRecyclerView;
...
public class MainActivity extends AppCompatActivity implements SongsChangeListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        playPauseImg = findViewById(R.id.playPauseTag);
        ...
        new Thread(new Runnable() {
            ...
            public void run() {
                try {
                    ...
                    e.printStackTrace();
                    Toast.makeText(MainActivity.this, "Unable to play the song", Toast.LENGTH_SHORT).show();
                }
